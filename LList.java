...
class LList<T> implements ListInterface<T> {
    ...
    */
    ...
    public void reverse() {
    	 ...
    	 Node prev = null; 
         Node current = firstNode; //Initializing the first node as the current 
         Node next = null; 
        //swapping the link list nodes
         while (current != null) { 
             next = current.next; 
             current.next = prev; 
             prev = current; 
        ...
        //making the last node as the first node
         firstNode = prev; 
         return;       
    ...
    public void cycle() {
       ...
       Node current = firstNode; //Initializing the firstnode as the current node
       //Storing first node in a temporary node
       Node temp= firstNode ;
       //Shifting firstnode to the next node
       firstNode=firstNode.next;
       //Shifting the nodes backwards
       while (current.next!= null) { 
           current=current.next;
       } 
     //Storing the value of first node in the last position 
       current.next=temp ;
       temp.next= null ;
